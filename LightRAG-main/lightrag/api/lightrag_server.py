...
def create_app(args):
    ...
    def create_optimized_embedding_function(
        ...
        try:
            ...
            elif binding == "hf_inference":
                from lightrag.llm.hf_inference import hf_inference_embed

                provider_func = hf_inference_embed
            elif binding == "azure_openai":
        ...
        async def optimized_embedding_function(texts, embedding_dim=None):
            try:
                if binding == "lollms":
                    ...
                    actual_func = (
                        hf_inference_embed.func
                        if isinstance(hf_inference_embed, EmbeddingFunc)
                        else hf_inference_embed
                    )
                    kwargs = {
                        "texts": texts,
                        "base_url": host,
